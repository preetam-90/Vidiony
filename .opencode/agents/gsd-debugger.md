...
<required_reading>
@/home/preetam/Downloads/Vidiony/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/preetam/Downloads/Vidiony/.opencode
                  → checks /home/preetam/Downloads/Vidiony/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/preetam/Downloads/Vidiony/.opencode/get-shit-done
                  → writes to /home/preetam/Downloads/Vidiony/.opencode/get-shit-done/hooks/
...
@/home/preetam/Downloads/Vidiony/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/preetam/Downloads/Vidiony/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/preetam/Downloads/Vidiony/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/preetam/Downloads/Vidiony/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/preetam/Downloads/Vidiony/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
