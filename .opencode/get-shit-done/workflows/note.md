...
- **Global scope**: `/home/preetam/Downloads/Vidiony/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/preetam/Downloads/Vidiony/.opencode/notes/`)
...
2. Glob `/home/preetam/Downloads/Vidiony/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/preetam/Downloads/Vidiony/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/preetam/Downloads/Vidiony/.opencode/notes/` — works in any directory
