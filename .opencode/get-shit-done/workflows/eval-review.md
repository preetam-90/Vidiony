...
```bash
AUDITOR_MODEL=$(node "/home/preetam/Downloads/Vidiony/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /home/preetam/Downloads/Vidiony/.opencode/agents/gsd-eval-auditor.md for instructions.
